#!/usr/bin/env node
// Claude Pal — PermissionRequest hook script (v2)
...
const DEFAULT_PROMPT_SOUND = { mac: "Glass", win: "Windows Notify", linux: "bell" };
...
process.stdin.on("end", () => {
  ...
  const soundName = eventCfg.sound || DEFAULT_PROMPT_SOUND[pk];
